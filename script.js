...
const YouTubeLinks = () => {
    const link = "https://www.youtube.com/watch?v=d5bZfz0ohRE&list=PLD9xos4mnoHROPklJMCUfKREJmRwXjqr2";
    const YTLink = (props) => {
        return (React.createElement("a", { className: "youtube-link", href: props.url, target: "_blank" },
            React.createElement("i", { className: "fa-brands fa-youtube" }),
            React.createElement("h1", null, props.label)));
    };
    return (React.createElement("div", { id: "youtube-links" },
        React.createElement(YTLink, { label: "Tutorial", url: link })));
};
const defaultSass = () => ({
    emoji: null,
    statement: ""
...
const SearchResults = (props) => {
    ...
    const getYouTubeLinks = () => {
        if (props.results.length > 0) {
            return (React.createElement(YouTubeLinks, null));
        }
    };
